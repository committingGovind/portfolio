  ...
  return (
    <div className="flex items-center justify-center mt-36">
      ...
      <div className="flex justify-center items-center ml-36">
        <a
          href="https://www.linkedin.com/in/govind-shukla-98a7a316b/"
          target="_blank"
        >
          <button className="transition-transform delay-50 ease-in-out hover:scale-110">
            <svg
        ...
        <a href="https://github.com/committingGovind" target="_blank">
          <button className="transition-transform delay-50 ease-in-out hover:scale-110 animate-bounce">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
